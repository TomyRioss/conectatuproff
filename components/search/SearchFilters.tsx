    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-3">
        <select
          ...
          className="h-10 px-3 rounded-full border border-gray-200 bg-white text-sm text-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-violet/30"
        >
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <select
            ...
            className="h-10 px-3 rounded-full border border-gray-200 bg-white text-sm font-medium text-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-violet/30"
          >
            {SORT_OPTIONS.map((o) => (
